<div class="wrap">
    <h1><?php _e( 'Edit Address', 'sixam-devs' ); ?></h1>

    <?php if ( isset( $_GET['address-updated'] ) ) { ?>
        <div class="notice notice-success">
            <p><?php _e( 'Address has been updated successfully!', 'sixam-devs' ); ?></p>
        </div>
    <?php } ?>
    ...
    <form action="" method="post">
        ...
        <?php submit_button( __( 'Update Address', 'sixam-devs' ), 'primary', 'submit_address' ); ?>
    </form>
</div>
